...
production = "https://admin.balsamee.com/api/v5/", staging = "https://admin-staging.balsamee.com/api/v5/", devlopment = "http://localhost:3000/api/v5/", language = $("#language").val(), $(document).ready(function () {
